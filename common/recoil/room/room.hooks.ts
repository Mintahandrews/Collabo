...
export const useSetUsers = () => {
  ...
  const handleRemoveUser = (userId: string) => {
    setRoom((prev) => {
      ...
      // Ensure movesWithoutUser is always an array before spreading
      const movesWithoutUser = Array.isArray(prev.movesWithoutUser)
      ...
      return {
        ...
        movesWithoutUser: [...movesWithoutUser, ...(userMoves || [])],
      };
    });
  };
